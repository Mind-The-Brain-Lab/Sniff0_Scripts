...
FULLSCREEN = True #DEBUGGING FULLSCREEN
#######################################################################################################################
## JITTERED ODORS AND EXPERIMENT NAME
#################################################################0######################################################
GENERAL_EXPERIMENT_NAME = 'ODO_02_POST'
all_stims = []
all_stims.append([2,3,3,1,1,3,4,1,2,1,4,2,3,4,4,2]) #RUN1
all_stims.append([4,3,3,2,1,3,2,1,4,1,2,2,4,3,1,4]) #RUN2
all_stims.append([4,3,2,2,4,1,3,2,4,2,3,3,1,1,4,1]) #RUN3
all_stims.append([1,2,3,1,1,2,3,2,4,4,2,3,1,4,3,4]) #RUN4
#######################################################################################################################
## OTHER PARAMETERS
#######################################################################################################################
